...
def compile_source(source, source_name="<program>", line_continuation="BACKSLASH", ampersand_comment=False):
    ...
    lines = [
        ...
        "",
        "program = GeneratedProgram(source_name={!r});".format(str(source_name)),
...
def compile_file(path, output=None, line_continuation="BACKSLASH", ampersand_comment=False):
